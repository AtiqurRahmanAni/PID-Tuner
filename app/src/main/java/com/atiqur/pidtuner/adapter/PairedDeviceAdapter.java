package com.atiqur.pidtuner.adapter;
...
import com.atiqur.pidtuner.databinding.ItemPairedDeviceBinding;
...
public class PairedDeviceAdapter extends RecyclerView.Adapter<PairedDeviceAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public com.atiqur.pidtuner.adapter.PairedDeviceAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());

        return new com.atiqur.pidtuner.adapter.PairedDeviceAdapter.ViewHolder(ItemPairedDeviceBinding.inflate((inflater),parent,false),parent.getContext(),mOnItemClick);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.atiqur.pidtuner.adapter.PairedDeviceAdapter.ViewHolder holder, int position) {
